...
from fees.models import Summary01, Summary02, Summary03, SummaryFee, FeeCBC, FeeADD, FeeCUP, SummaryATM
...
def UpdateSummaryFee(request):
    ...
    for t in tb:
        ...
        result03 = 0
        result04 = 0
        result01 = Summary02.objects.filter(BRANCH = t.code_unit).aggregate(atm=Sum('ATMFEE'), bal=Sum('BALFEE'), min=Sum('MINIFEE'), fund=Sum('FUNDFEE'), nac=Sum('NACFEE'), cbc=Sum('CBCFEE'))
        ...
        if result01['cbc'] != None:
            if  result01['atm'] is None:
                ...
                q1 = round((result01['atm'] + result01['bal'] + result01['min'] + result01['fund'] + result01['nac'] + result01['cbc'])/1.1)
        ...
        if form.is_valid():
            ...
            request.FILES["file"].save_book_to_database(
                ...
                mapdicts=[
                    ...
                    {"BRANCH":"BRANCH", "ATMNAME":"ATMNAME", "TERMINALID":"TERMINALID", "ATMFEE":"ATMFEE", "BALFEE":"BALFEE", "MINIFEE":"MINIFEE", "FUNDFEE":"FUNDFEE", "NACFEE":"NACFEE", "CBCFEE":"CBCFEE"},
